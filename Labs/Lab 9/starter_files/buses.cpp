...
class Bus {
 ...
 public:
  ...
  Bus(string r, vector<string> s, int d);
  void drive();
  bool getOn(Rider rider);
  bool stopsAt(string stop);
};
...
Bus::Bus(string r, vector<string> s, int d) {
...
/* YOUR BUS drive FUNCTION HEADER HERE */ void Bus::drive() {
