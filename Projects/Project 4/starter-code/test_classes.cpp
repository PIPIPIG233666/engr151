...
void test_case(const int case_number) {
  switch (case_number) {
    ...
    case 1: {
      ...
      radioNuclide F18(lambda,
                       N0);  // Construct population of Fluorine18 nuclei
    ...
    case 2: {
      ...
      while (t < tmax + dt) {  // Loop while within defined simulation time
        ...
        Tc99m +=
            Mo99.Decay(dt);  // Decay Mo population, adding to the Tc population
    ...
    case 3: {
      ...
      while (t < tmax + dt) {  // Loop while within defined simulation time
        Tc99m += Mo99.Decay(
            dt);  // Decay the Mo population, adding to the Tc population
